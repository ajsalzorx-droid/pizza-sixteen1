...
export default function Home() {
  ...
  return <main>
    ...
    {scrolled&&<div className="floating-order"><button onClick={() => setCartOpen(true)}><ShoppingBag/> <span>Cart {cartCount > 0 ? `(${cartCount})` : ""}</span></button><a href="https://wa.me/971543962660" target="_blank" rel="noopener noreferrer" aria-label="Order on WhatsApp"><Image className="whatsapp-icon" src="/images/whatsapp-icon.png" alt="" width={30} height={30}/><span>WhatsApp</span></a></div>}
  </main>;
}
