...
export default function Home() {
  ...
  return <main>
    ...
    <section className="locations section" id="locations"><motion.div {...reveal}><p className="eyebrow">DUBAI, UAE</p><h2>FIND YOUR<br/><em>NEAREST SLICE.</em></h2><p>Sunday–Thursday: 11:00 AM–1:00 AM<br/>Friday–Saturday: 11:00 AM–2:00 AM</p><div className="hero-buttons"><a className="button" href="https://maps.app.goo.gl/XjJHddAN3T2N6BVg7" target="_blank" rel="noopener noreferrer" aria-label="Open Pizza Sixteen shop location in Google Maps">Get directions</a><a className="button outline" href="tel:+971543962660">Call store</a></div></motion.div><div className="map"><MapPin size={70}/><b>PIZZA<br/>SIXTEEN</b><i/><i/><i/></div></section>
